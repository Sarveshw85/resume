const profileData = {
  title: "Resume",
  name: "Sarveshwaran R",
  sub_title: "Windows Administrator
  logoURL: ""C:\Users\Sarveshwaran\Downloads\HTML\sarvesh.JPG"",
  about: {
    ...
    contact: {
      email: "2019wa86185@wilp.bits-pilani.ac.in",
      phone: "+91-9789640440",
      address: "Veerakeralam ,Coimbatore 641007",
    },
  },
  ...
  education: [
    ...
    {
      alma: "SKASC,Coimbatore,
      duration: "2016 - 2019",
      std: "B.Sc (Computer Science and Applications",
      score: "74.00%",
    },
    {
  ...
  certifications: [
    {
      desc: `<strong>Photo Editing</strong> by <strong>SNMV College</strong>.
      ,
      date: "May  2020",
    },
